...
class _HomePageState extends State<HomePage> {
  ...
  Future<List<Books>> _getBooks() async {
    print('to read url');
    var data = await http.get("http://192.168.254.102:8000/api/books");
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index){
                    return ListTile(
                      ...
                      leading: Image(image: NetworkImage(snapshot.data[index].image_url != null ? "http://192.168.254.102:8000/images/" + snapshot.data[index].image_url : "http://192.168.254.102:8000/images/nobookcover.jpg"),),
                      title: Column(
                        children: <Widget>[
                          Align(
